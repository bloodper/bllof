...
async def start(event):
  await event.reply("**Blood Tagger**\n Gelişmiş Etiket Botu  \nKomutlar: /help",
                    buttons=(
                   
		      [Button.url('Gruba Ekle ➕', 'https://t.me/BloodTaggerBot?startgroup=a')],
                      [Button.url('Kanalimiz📣', 'https://t.me/EpicEyeBots')],
		      [Button.url('Gelistirici🤙', 'https://t.me/BloodperBio')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**Blood Tagger Yardim**\n\n**/tag <SEBEP> : 5 li Tag Atar **\n\n**/etag <SEBEP> : Emojili Tag Atar**\n\n**/tektag <SEBEP> : Tekli Tag Atar**\n\n**/admins <SEBEP> :Yöneticilere Tekli Tag Atar **\n\n**/start : Botu Baslat**"
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @BloodTaggerBot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @BloodTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
...
async def mentionall(event):
  ...
  if event.pattern_match.group(1):
    ...
    if msg == None:
        return await event.respond("**Geçmiş mesajlari Etiketleye bilmiyorum!**")
